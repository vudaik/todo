...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/devalue/index.js';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/VuDoan/Sample_Projects/todo/apps/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/VuDoan/Sample_Projects/todo/apps/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\VuDoan\\Sample_Projects\\todo\\apps","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\VuDoan\\Sample_Projects\\todo\\apps\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\VuDoan\\Sample_Projects\\todo\\apps\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\VuDoan\\Sample_Projects\\todo\\apps\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\VuDoan\\Sample_Projects\\todo\\apps\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _CY6grLy7E6 = (function(nitro) {
...
const _lazy_Ip8hm7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Ip8hm7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Ip8hm7, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/VuDoan/Sample_Projects/todo/apps/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/VuDoan/Sample_Projects/todo/apps/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
